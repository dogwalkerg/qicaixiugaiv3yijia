...
<html class="full-height" lang="en-US">
  <head>
	...
	<meta name="description" content="Shadowrocket官网，全新一代的轻型加速服务">
...
#intro {
  background: url("/img/random.jpeg") no-repeat center center;
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                   ...
                   <li>
                        <a href="user">
                            <i class="material-icons">account_circle</i> 用户中心
                        </a>
                    </li>
                  {else}
                                      <li>
                  ...
                  {/if}
                 	 ...
                 	 <li>
                      	<a href="tos">
                          <i class="material-icons">turned_in_not</i> 服务条款
                      </a>
                  	</li>
                                  </ul>
            </div>
              ...
              <div class="col-md-10 col-lg-6 text-center text-md-left margins">
                <div class="white-text">
                  <div class="wow fadeInLeft" data-wow-delay="0.3s">
                    <h1 class="h1-responsive font-bold mt-sm-5">因为专注，所以专业</h1>
                    <div class="h6" style="text-transform:none">
                    Shadowrocket官网，一款能上外网+游戏加速的工具，全新一代的轻型加速服务。抗干扰性更强，数据传输速度更快更稳定。线路覆盖：香港、韩国、台湾、日本、越南新加坡、俄罗斯、加拿大、美国等，全球10+数据中心、10+动态加速节点，助您网络加速。
                    </div>
                  </div><br>
                  ...
                  <div class="wow fadeInLeft" data-wow-delay="0.3s">
                    {if $user->isLogin}
                    <a class="btn btn-outline-white waves-effect waves-light" href="user" ><i class="material-icons">account_circle</i> 用户中心<div class="ripple-container"></div></a>
                    <a class="btn btn-outline-white waves-effect waves-light" href="user/shop" ><i class="material-icons">shop</i> 购买套餐<div class="ripple-container"></div></a>
                    {else}
                                        <a class="btn btn-white dark-grey-text font-bold ml-0" href="auth/register" ><i class="fa fa-play mr-1"></i>注册免费试用</a>
                     <a class="btn btn-outline-white waves-effect waves-light" href="auth/login" ><i class="material-icons">navigation</i>前往登陆<div class="ripple-container"></div></a>
                    {/if}
                                      </div>
                </div>
              </div>
  ...
  <div class="container">
    <div class="wow fadeIn">
      ...
      <p class="px-5 mb-5 pb-3 lead blue-grey-text">
        全球近20个加速网络连接服务点,专业的网络加速CN2直连线路，为客户提供高速稳定的加速体验．
      </p>
    </div>
    <div class="row">
      <div class="col-md-4 mb-r wow fadeInUp" data-wow-delay=".3s"><i class="fa fa-dashboard fa-3x orange-text"></i>
        ...
        <p class="mt-3 blue-grey-text">
          加速网络均部署了先进的TCP加速技术，用户无需下载任何额外软件，就可以享受到DotDot云加速加速网络带来的高速度.
        </p>
      </div>
...
<section class="py-5" id="projects">
  <div class="container">
    ...
    <div class="row wow fadeInLeft" data-wow-delay=".3s">
      <div class="col-lg-6 col-xl-5 pr-lg-5 pb-5"><img class="img-fluid rounded z-depth-2" src="img/card-1.jpg" alt="project image"/></div>
    ...
    <div class="row pt-5 wow fadeInRight" data-wow-delay=".3s">
      ...
      <div class="col-lg-6 col-xl-5 mb-3"><img class="img-fluid rounded z-depth-2" src="img/card-2.jpeg" alt="project image"/></div>
    </div>
  </div>
</section>
<section class="text-center py-5 indigo darken-1 text-white" id="pricing">
  <div class="container">
    <div class="wow fadeIn">
      <h2 class="h1 pt-5 pb-3">多种套餐</h2>
      <p class="px-5 mb-5 pb-3 lead">
       Shadowrocket网络加速器提供多种套餐，以极大地满足不同客户的需求，不同于其他网络服务商，我们的服务价格更加亲民，并不定期发布优惠码，加群获取。
      </p>
    </div>
      ...
      <div class="col-lg-4 col-md-12 mb-r">
        <div class="card card-image">
          <div class="text-white text-center pricing-card d-flex align-items-center rgba-stylish-strong py-3 px-3 rounded">
            <div class="card-body">
              <div class="h5">月付套餐</div>
              <div class="py-5"><sup class="display-4">CNY</sup><span class="display-1">28</span><span class="display-4">/t</span></div>
              <ul class="list-unstyled">
                <li>
                  <p><strong>20</strong> GB</p>
                </li>
                <li>
                  <p><strong>全站</strong> 线路</p>
                </li>
                <li>
                  <p><strong>5</strong> 连接设备</p>
                </li>
                <li>
                  <p><strong>24/7</strong> 在线支持</p>
                </li>
              </ul><a class="btn btn-outline-white mt-5" href="user/shop"> Buy now</a>
            </div>
          </div>
        </div>
      </div>
      <div class="col-lg-4 col-md-12 mb-r">
        <div class="card card-image">
          <div class="text-white text-center pricing-card d-flex align-items-center rgba-teal-strong py-3 px-3 rounded">
            <div class="card-body">
              <div class="h5">季度套餐</div>
              <div class="py-5"><sup class="display-4">CNY</sup><span class="display-1">45</span><span class="display-4">/m</span></div>
              <ul class="list-unstyled">
                <li>
                  <p><strong>200</strong> GB</p>
                </li>
                <li>
                  <p><strong>全站</strong> 线路</p>
                </li>
      ...
      <div class="col-lg-4 col-md-12 mb-r">
        <div class="card card-image">
          <div class="text-white text-center pricing-card d-flex align-items-center rgba-red-strong py-3 px-3 rounded">
            <div class="card-body">
              <div class="h5">年付套餐</div>
              <div class="py-5"><sup class="display-4">CNY</sup><span class="display-1">128</span><span class="display-4">/y</span></div>
              <ul class="list-unstyled">
                <li>
                  <p><strong>2048</strong> GB</p>
                </li>
                <li>
                  <p><strong>全站</strong> 线路</p>
                </li>
                <li>
                  <p><strong>10</strong> 连接设备</p>
                </li>
                <li>
                 <p><strong>24/7</strong> 在线支持</p>
                </li>
